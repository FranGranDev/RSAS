...
namespace Application.Pages.Companies
{
    public class OrderingModel : CatalogProducts
    {
        ...
        public OrderingModel(DataManager dataManager, ICompanyStore companyStore, UserManager<AppUser> userManager,
            IMemoryCache memoryCache, IConfiguration configuration) : base(memoryCache)
        {
        ...
        [BindNever] public CompanyViewModel Company { get; set; }
