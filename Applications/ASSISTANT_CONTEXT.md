...
- [x] Разделение проекта на Backend и Frontend
- [x] Реализация WEB API
...
- Тестирование: xUnit, Moq (в процессе настройки)
...
└── Application.Tests/     # Проект для модульных тестов (в процессе настройки)
