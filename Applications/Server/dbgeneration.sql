...
[
    ...
    CONSTRAINT [FK_StockProducts_Products_ProductId] FOREIGN KEY
(
[
    ProductId]
) REFERENCES [Products]
...
[
    ...
    CONSTRAINT [FK_StockProducts_Stocks_StockId] FOREIGN KEY
(
[
    StockId]
) REFERENCES [Stocks]
...
IF
@var0 IS NOT NULL EXEC(N'ALTER TABLE [AspNetUsers] DROP CONSTRAINT [' + @var0 + '];');
...
[
    ...
    CONSTRAINT [FK_Clients_AspNetUsers_UserId] FOREIGN KEY
(
[
    UserId]
) REFERENCES [AspNetUsers]
...
[
    ...
    CONSTRAINT [FK_Companies_AspNetUsers_UserId] FOREIGN KEY
(
[
    UserId]
) REFERENCES [AspNetUsers]
...
IF
@var2 IS NOT NULL EXEC(N'ALTER TABLE [Companies] DROP CONSTRAINT [' + @var2 + '];');
...
IF
@var3 IS NOT NULL EXEC(N'ALTER TABLE [Clients] DROP CONSTRAINT [' + @var3 + '];');
...
IF
@var4 IS NOT NULL EXEC(N'ALTER TABLE [AspNetUsers] DROP CONSTRAINT [' + @var4 + '];');
...
IF
@var5 IS NOT NULL EXEC(N'ALTER TABLE [AspNetUsers] DROP CONSTRAINT [' + @var5 + '];');
...
VALUES (N'admin', N'71c18bde-401a-472a-9a46-0ae30382a7a4', N'Admin', N'ADMIN'), (N'client', N'5594336a-09e1-4f2d-acdd-f33ece4016ad', N'Client', N'CLIENT');
IF
...
[
    ...
    CONSTRAINT [FK_Employees_AspNetUsers_UserId] FOREIGN KEY
(
[
    UserId]
) REFERENCES [AspNetUsers]
...
[
    ...
    CONSTRAINT [FK_Orders_AspNetUsers_UserId] FOREIGN KEY
(
[
    UserId]
) REFERENCES [AspNetUsers]
...
[
    ...
    CONSTRAINT [FK_Orders_Stocks_StockId] FOREIGN KEY
(
[
    StockId]
) REFERENCES [Stocks]
...
(
    ...
    CONSTRAINT [PK_OrderInfo] PRIMARY KEY
(
[
    Id]
),
    CONSTRAINT [FK_OrderInfo_Orders_OrderId] FOREIGN KEY
(
[
    OrderId]
) REFERENCES [Orders]
...
[
    ...
    CONSTRAINT [FK_OrderProducts_Orders_OrderId] FOREIGN KEY
(
[
    OrderId]
) REFERENCES [Orders]
...
[
    ...
    CONSTRAINT [FK_OrderProducts_Products_ProductId] FOREIGN KEY
(
[
    ProductId]
) REFERENCES [Products]
...
[
    ...
    CONSTRAINT [FK_Sales_Orders_OrderId] FOREIGN KEY
(
[
    OrderId]
) REFERENCES [Orders]
...
IF
@var6 IS NOT NULL EXEC(N'ALTER TABLE [Orders] DROP CONSTRAINT [' + @var6 + '];');
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Orders]') AND [c].[name] = N'StockId');
IF
@var7 IS NOT NULL EXEC(N'ALTER TABLE [Orders] DROP CONSTRAINT [' + @var7 + '];');
...
(
    ...
    CONSTRAINT [PK_OrdersDelivery] PRIMARY KEY
(
[
    Id]
),
    CONSTRAINT [FK_OrdersDelivery_Orders_Id] FOREIGN KEY
(
[
    Id]
) REFERENCES [Orders]
...
IF
@var8 IS NOT NULL EXEC(N'ALTER TABLE [OrdersDelivery] DROP CONSTRAINT [' + @var8 + '];');
...
IF
@var9 IS NOT NULL EXEC(N'ALTER TABLE [Orders] DROP CONSTRAINT [' + @var9 + '];');
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Orders]') AND [c].[name] = N'StockId');
IF
@var10 IS NOT NULL EXEC(N'ALTER TABLE [Orders] DROP CONSTRAINT [' + @var10 + '];');
ALTER TABLE [Orders] ALTER COLUMN [StockId] int NULL;
GO
