...
namespace Server.Tests.Controllers
{
    public class ProductsControllerTests : TestBase
    {
        ...
        public ProductsControllerTests(ITestOutputHelper output) : base(output)
        {
            _output = output;
        }
        ...
        private async Task<(string token, string userId)> LoginAsManager()
        {
            ...
            {
                UserName = $"manager{DateTime.Now.Ticks}@test.com",
                Email = $"manager{DateTime.Now.Ticks}@test.com",
                EmailConfirmed = true,
            ...
            return (loginResult.Token, manager.Id);
        }

        private async Task<(string token, string userId)> LoginAsUser()
        {
